...
def legs(request):
    ...
    return render(request,'legs.html',{'video':video})
...
def userprofile(request,id):
    ...
    return render(request,'userprofile.html',{'posts':posts,'video':video,'profuser':profuser,'recepies':recepies})
...
def following(request,id):
    ...
    return render(request,'userprofile.html',{'following':following,'posts':posts,'video':video,'profuser':profuser,'recepies':recepies})
